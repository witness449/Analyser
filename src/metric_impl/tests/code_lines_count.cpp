...
TEST_F(CodeLinesCountMetricTest, LinesOfExceptions) {
    ...
    ASSERT_EQ(std::get<int>(metric.Calculate(f).value), 8);
}
...
TEST_F(CodeLinesCountMetricTest, LinesOfLoops) {
    ...
    ASSERT_EQ(std::get<int>(metric.Calculate(f).value), 7);
}
...
TEST_F(CodeLinesCountMetricTest, LinesOfManyLines) {
    ...
    ASSERT_EQ(std::get<int>(metric.Calculate(f).value), 11);
}
...
TEST_F(CodeLinesCountMetricTest, LinesOfNestedIf) {
    ...
    ASSERT_EQ(std::get<int>(metric.Calculate(f).value), 9);
}
...
TEST_F(CodeLinesCountMetricTest, LinesOfSimple) {
    ...
    ASSERT_EQ(std::get<int>(metric.Calculate(f).value), 6);
}
